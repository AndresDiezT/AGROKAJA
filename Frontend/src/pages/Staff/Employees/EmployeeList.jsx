...
import { useEmployeesUser } from '../../../hooks/queries/useUser'
...
export default function EmployeeList() {
    ...
    const { data: employees = [], isLoading, isError, error } = useEmployeesUser(cleanedFilters)
    ...
    return (
        <>
            ...
            <UsersDataTable
                ...
                editUrl={(rowData) => `/staff/employees/edit/${rowData.document}`}
                detailUrl={(rowData) => `/staff/employees/${rowData.document}`}
