import { FiUser, FiUploadCloud, FiPackage, FiTruck,
    FiSearch, FiShoppingCart, FiHome, FiThumbsUp,
    FiShield, FiTag, FiBox, FiHeart,
    FiCoffee, FiDroplet, FiFeather } from "react-icons/fi";

const categories = [
    { name: "Frutas", icon: <FiFeather />, description: "Mangos, bananos, aguacates..." },
    { name: "Verduras", icon: <FiDroplet />, description: "Papa, zanahoria, cebolla..." },
    { name: "Granos", icon: <FiBox />, description: "Maíz, arroz, frijol..." },
    { name: "Productos artesanales", icon: <FiCoffee />, description: "Café, panela, mermeladas..." },
];
